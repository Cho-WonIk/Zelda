...
public:
	...
	UFUNCTION(BlueprintPure)
	FORCEINLINE UZCLockSpringArmComponent* GetCameraBoom() const { return CameraBoom; }
...
protected:
	...
	*/
	...
	// 주목 버튼
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input, meta = (AllowPrivateAccess = "true"))
	TObjectPtr<UInputAction> AttentionAction;
	// 기어 조작 무브먼트
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input, meta = (AllowPrivateAccess = "true"))
	TObjectPtr<UInputAction> RideMoveAction;
...
public:
	...
	// 탑승 기어 등록
	void SetRideGear(AZCInputGearActor* GearActor);
...
/*==================기어 라이딩 로직 ===================*/
protected:
	void RideGearMove(const FInputActionValue& Value);

	AZCInputGearActor* CurrentRideGear = nullptr;
